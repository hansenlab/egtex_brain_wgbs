# Call CC_neg-DMRs for hg38-aligned Phase2 brain samples aka "eGTEx Phase2
# brain samples".
# Peter Hickey
# 2018-11-06
...
file.copy(
  from = here(
    ...
    "BSseq",
    "eGTEx.Phase2_brain_samples.mCC_neg.small_smooth",
    "eGTEx.Phase2_brain_samples.mCC_neg.small_smooth.general_DMRs",
    "se.rds"),
  to = bsseq_tempdir)
file.copy(
  from = here(
...
saveRDS(
  ...
  file = here(
    ...
    "Sorted_GTEx_Brain_hg38",
    "CC_neg-DMRs",
    "eGTEx.Phase2_brain_samples.general_CC_neg-DMRs.fstat_pipeline.rds"))
saveRDS(
  object = fstat_pipeline$dmrs[fstat_pipeline$dmrs$fwer < 50, ],
  file = here("DMRs", "objects", "general_CC_neg-DMRs.rds"))

# Hippocampus CC_neg-DMRs ------------------------------------------------------
...
file.copy(
  from = here(
    ...
    "BSseq",
    "eGTEx.Phase2_brain_samples.mCC_neg.small_smooth",
    "eGTEx.Phase2_brain_samples.mCC_neg.small_smooth.hippocampus_DMRs",
    "se.rds"),
  to = bsseq_tempdir)
file.copy(
  from = here(
...
saveRDS(
  ...
  file = here(
    ...
    "Sorted_GTEx_Brain_hg38",
    "CC_neg-DMRs",
    "eGTEx.Phase2_brain_samples.hippocampus_CC_neg-DMRs.fstat_pipeline.rds"))
saveRDS(
  object = fstat_pipeline$dmrs[fstat_pipeline$dmrs$fwer < 50, ],
  file = here("DMRs", "objects", "hippocampus_CC_neg-DMRs.rds"))

# Basal ganglia CC_neg-DMRs ----------------------------------------------------
...
file.copy(
  from = here(
    ...
    "BSseq",
    "eGTEx.Phase2_brain_samples.mCC_neg.small_smooth",
    "eGTEx.Phase2_brain_samples.mCC_neg.small_smooth.basal_ganglia_DMRs",
    "se.rds"),
  to = bsseq_tempdir)
file.copy(
  from = here(
...
saveRDS(
  ...
  file = here(
    ...
    "Sorted_GTEx_Brain_hg38",
    "CC_neg-DMRs",
    "eGTEx.Phase2_brain_samples.basal_ganglia_CC_neg-DMRs.fstat_pipeline.rds"))
saveRDS(
  object = fstat_pipeline$dmrs[fstat_pipeline$dmrs$fwer < 50, ],
  file = here("DMRs", "objects", "basal_ganglia_CC_neg-DMRs.rds"))
