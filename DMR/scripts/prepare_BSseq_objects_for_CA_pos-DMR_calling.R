...
# BSseq objects for calling CA_pos-DMRs.
# Peter Hickey
# 2018-11-01
...
#       prop.table(table(zero_coverage)) shows we retain 43% of loci
#       (remove 115,880,521 loci).
