# Make HDF5-backed BSseq objects for hg38-aligned Phase2 brain samples aka
# "eGTEx Phase2 brain samples".
# Peter Hickey
# 2018-12-03
...
out_name <- "eGTEx.Phase2_brain_samples.mCG"
...
out_name <- "eGTEx.Phase2_brain_samples.mCA_pos"
scratch_dir <- file.path(tempdir(), out_name)
stopifnot(!dir.exists(scratch_dir))
...
file.copy(
  from = list.files(
    path = here("HDF5", "extdata", "Sorted_GTEx_Brain_hg38", "BSseq", out_name),
    full.names = TRUE),
...
out_name <- "eGTEx.Phase2_brain_samples.mCA_neg"
scratch_dir <- file.path(tempdir(), out_name)
stopifnot(!dir.exists(scratch_dir))
...
out_name <- "eGTEx.Phase2_brain_samples.mCT_pos"
scratch_dir <- file.path(tempdir(), out_name)
stopifnot(!dir.exists(scratch_dir))
...
out_name <- "eGTEx.Phase2_brain_samples.mCT_neg"
scratch_dir <- file.path(tempdir(), out_name)
stopifnot(!dir.exists(scratch_dir))
...
out_name <- "eGTEx.Phase2_brain_samples.mCC_pos"
scratch_dir <- file.path(tempdir(), out_name)
stopifnot(!dir.exists(scratch_dir))
...
out_name <- "eGTEx.Phase2_brain_samples.mCC_neg"
scratch_dir <- file.path(tempdir(), out_name)
stopifnot(!dir.exists(scratch_dir))
